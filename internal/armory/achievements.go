...
// Achievement names from WotLK 3.3.5a Achievement.dbc (English).
// Source: azerothcore wiki Achievement.dbc content table.
var achievementNames = map[uint32]string{
	6:    "Level 10",
	7:    "Level 20",
	8:    "Level 30",
	9:    "Level 40",
